package com.example.MLSfinal.model;
...
public class MLSData {
		...
		private int Ass_year;
		private int Bath_tot;
		private int Br;
		private int Br_plus;
		...
		private int Mmap_col;//
		private int Mmap_page;//
		...
		private int Wcloset_p1;
		private int Wcloset_p2;
		private int Wcloset_p3;
		private int Wcloset_p4;
		private int Wcloset_p5;
		private int Wcloset_t1;
		private String Wcloset_t1lvl;
		private int Wcloset_t2;
		private String Wcloset_t2lvl;
		private int Wcloset_t3;
		private String Wcloset_t3lvl;
		private int Wcloset_t4;
		private String Wcloset_t4lvl;
		private int Wcloset_t5;
		...
		public int getAss_year() {
			return Ass_year;
		}

		public void setAss_year(int ass_year) {
			Ass_year = ass_year;
		}

		public int getBath_tot() {
			return Bath_tot;
		}

		public void setBath_tot(int bath_tot) {
			Bath_tot = bath_tot;
		}
		...
		public int getBr_plus() {
			return Br_plus;
		}

		public void setBr_plus(int br_plus) {
			Br_plus = br_plus;
		}
		...
		public int getKit_plus() {
			return Kit_plus;
		}

		public void setKit_plus(int kit_plus) {
			Kit_plus = kit_plus;
		}
		...
		public int getMmap_col() {
			return Mmap_col;
		}

		public void setMmap_col(int mmap_col) {
			Mmap_col = mmap_col;
		}

		public int getMmap_page() {
			return Mmap_page;
		}

		public void setMmap_page(int mmap_page) {
			Mmap_page = mmap_page;
		}
		...
		public int getNum_kit() {
			return Num_kit;
		}

		public void setNum_kit(int num_kit) {
			Num_kit = num_kit;
		}
		...
		public int getRooms_plus() {
			return Rooms_plus;
		}

		public void setRooms_plus(int rooms_plus) {
		...
		public int getWcloset_p1() {
			return Wcloset_p1;
		}

		public void setWcloset_p1(int wcloset_p1) {
			Wcloset_p1 = wcloset_p1;
		}

		public int getWcloset_p2() {
			return Wcloset_p2;
		}

		public void setWcloset_p2(int wcloset_p2) {
			Wcloset_p2 = wcloset_p2;
		}

		public int getWcloset_p3() {
			return Wcloset_p3;
		}

		public void setWcloset_p3(int wcloset_p3) {
			Wcloset_p3 = wcloset_p3;
		}

		public int getWcloset_p4() {
			return Wcloset_p4;
		}

		public void setWcloset_p4(int wcloset_p4) {
			Wcloset_p4 = wcloset_p4;
		}

		public int getWcloset_p5() {
			return Wcloset_p5;
		}

		public void setWcloset_p5(int wcloset_p5) {
			Wcloset_p5 = wcloset_p5;
		}

		public int getWcloset_t1() {
			return Wcloset_t1;
		}

		public void setWcloset_t1(int wcloset_t1) {
		...
		public int getWcloset_t2() {
			return Wcloset_t2;
		}

		public void setWcloset_t2(int wcloset_t2) {
		...
		public int getWcloset_t3() {
			return Wcloset_t3;
		}

		public void setWcloset_t3(int wcloset_t3) {
		...
		public int getWcloset_t4() {
			return Wcloset_t4;
		}

		public void setWcloset_t4(int wcloset_t4) {
		...
		public int getWcloset_t5() {
			return Wcloset_t5;
		}

		public void setWcloset_t5(int wcloset_t5) {
		...
		public MLSData(String A_c, String Ad_text, String Community, String Ml_num) {
			super();
			this.A_c = A_c;
		...
		public MLSData(MLSDataPOJO pojo) {
			super();
			A_c = pojo.getA_c();
