...
import com.example.MLSfinal.model.MLSDataPOJO;
import com.example.MLSfinal.repo.MLSRepository;
import com.example.MLSfinal.utils.MapperUtil;
...
public class MlSdemoApplication implements CommandLineRunner {
	...
	public static void main(String[] args) {
		SpringApplication.run(MlSdemoApplication.class, args);
	}
	...
	// Get MLS listing
	void getMLSListing() {
		// Create a RetsHttpClient (other constructors provide configuration i.e.
		// timeout, gzip capability)
	...
	private List<String> getImage(String ml_num, RetsSession session) {
		...
		try {
			...
			/*
			 * if(session != null) { try { session.logout(); } catch (RetsException e) {
			 * e.printStackTrace(); } }
			 */
		}
		return imagesList;
	...
	private MLSDataPOJO createPojo(String[] resp) throws ParseException {
		MLSDataPOJO pojo = new MLSDataPOJO();
		...
		if (resp[5] != null && resp[5].trim().length() != 0) {
			pojo.setAddl_mo_fee(Integer.parseInt(resp[5]));
		} else {
			pojo.setAddl_mo_fee(Integer.parseInt("0"));
		}
		pojo.setAddr(resp[6]);
		...
		if (resp[13] != null && resp[13].trim().length() != 0) {
			pojo.setAss_year(Integer.parseInt(resp[13]));
		} else {
			pojo.setAss_year(Integer.parseInt("0"));
		}
		if (resp[14] != null && resp[14].trim().length() != 0) {
			pojo.setBath_tot(Integer.parseInt(resp[14]));
		} else {
			pojo.setBath_tot(Integer.parseInt("0"));
		}
		if (resp[15] != null && resp[15].trim().length() != 0) {
			pojo.setBr(Integer.parseInt(resp[15]));
		} else {
			pojo.setBr(Integer.parseInt("0"));
		}
		if (resp[16] != null && resp[16].trim().length() != 0) {
			pojo.setBr_plus(Integer.parseInt(resp[16]));
		} else {
			pojo.setBr_plus(Integer.parseInt("0"));
		}
		...
		if (resp[36] != null && resp[36].trim().length() != 0) {
			pojo.setDepth(Integer.parseInt(resp[36]));
		} else {
			pojo.setDepth(Integer.parseInt("0"));
		}
		pojo.setDisp_addr(resp[37]);
		if (resp[38] != null && resp[38].trim().length() != 0) {
			pojo.setDom(Integer.parseInt(resp[38]));
		} else {
			pojo.setDom(Integer.parseInt("0"));
		}
		...
		if (resp[52] != null && resp[52].trim().length() != 0) {
			pojo.setFront_ft(Integer.parseInt(resp[52]));
		} else {
			pojo.setFront_ft(Integer.parseInt("0"));
		}
		pojo.setFuel(resp[53]);
		pojo.setFurnished(resp[54]);
		if (resp[55] != null && resp[55].trim().length() != 0) {
			pojo.setGar_spaces(Integer.parseInt(resp[55]));
		} else {
			pojo.setGar_spaces(Integer.parseInt("0"));
		}
		...
		if (resp[66] != null && resp[66].trim().length() != 0) {
			pojo.setKit_plus(Integer.parseInt(resp[66]));
		} else {
			pojo.setKit_plus(Integer.parseInt("0"));
		}
		...
		if (resp[89] != null && resp[89].trim().length() != 0) {
			pojo.setLp_dol(Integer.parseInt(resp[89]));
		} else {
			pojo.setLp_dol(Integer.parseInt("0"));
		}
		pojo.setLsc(resp[90]);
		pojo.setLse_terms(resp[91]);
		pojo.setMl_num(resp[92]);
		if (resp[93] != null && resp[93].trim().length() != 0) {
			pojo.setMmap_col(Integer.parseInt(resp[93]));
		} else {
			pojo.setMmap_col(Integer.parseInt("0"));
		}
		if (resp[94] != null && resp[94].trim().length() != 0) {
			pojo.setMmap_page(Integer.parseInt(resp[94]));
		} else {
			pojo.setMmap_page(Integer.parseInt("0"));
		}
		...
		if (resp[99] != null && resp[99].trim().length() != 0) {
			pojo.setNum_kit(Integer.parseInt(resp[99]));
		} else {
			pojo.setNum_kit(Integer.parseInt("0"));
		}
		...
		if (resp[132] != null && resp[132].trim().length() != 0) {
			pojo.setOrig_dol(Integer.parseInt(resp[132]));
		} else {
			pojo.setOrig_dol(Integer.parseInt("0"));
		}
		...
		if (resp[137] != null && resp[137].trim().length() != 0) {
			pojo.setPark_chgs(Integer.parseInt(resp[137]));
		} else {
			pojo.setPark_chgs(Integer.parseInt("0"));
		}
		if (resp[138] != null && resp[138].trim().length() != 0) {
			pojo.setPark_spcs(Integer.parseInt(resp[138]));
		} else {
			pojo.setPark_spcs(Integer.parseInt("0"));
		}
		pojo.setPay_freq(resp[139]);
		if (resp[140] != null && resp[140].trim().length() != 0) {
			pojo.setPerc_dif(Integer.parseInt(resp[140]));
		} else {
			pojo.setPerc_dif(Integer.parseInt("0"));
		}
		...
		if (resp[160] != null && resp[160].trim().length() != 0) {
			pojo.setRm1_len(Integer.parseInt(resp[160]));
		} else {
			pojo.setRm1_len(Integer.parseInt("0"));
		}
		pojo.setRm1_out(resp[161]);
		if (resp[162] != null && resp[162].trim().length() != 0) {
			pojo.setRm1_wth(Integer.parseInt(resp[162]));
		} else {
			pojo.setRm1_wth(Integer.parseInt("0"));
		}
		...
		if (resp[166] != null && resp[166].trim().length() != 0) {
			pojo.setRm10_len(Integer.parseInt(resp[166]));
		} else {
			pojo.setRm10_len(Integer.parseInt("0"));
		}
		pojo.setRm10_out(resp[167]);
		if (resp[168] != null && resp[168].trim().length() != 0) {
			pojo.setRm10_wth(Integer.parseInt(resp[168]));
		} else {
			pojo.setRm10_wth(Integer.parseInt("0"));
		}
		...
		if (resp[172] != null && resp[172].trim().length() != 0) {
			pojo.setRm11_len(Integer.parseInt(resp[172]));
		} else {
			pojo.setRm11_len(Integer.parseInt("0"));
		}
		pojo.setRm11_out(resp[173]);
		if (resp[174] != null && resp[174].trim().length() != 0) {
			pojo.setRm11_wth(Integer.parseInt(resp[174]));
		} else {
			pojo.setRm11_wth(Integer.parseInt("0"));
		}
		...
		if (resp[178] != null && resp[178].trim().length() != 0) {
			pojo.setRm12_len(Integer.parseInt(resp[178]));
		} else {
			pojo.setRm12_len(Integer.parseInt("0"));
		}
		pojo.setRm12_out(resp[179]);
		if (resp[180] != null && resp[180].trim().length() != 0) {
			pojo.setRm12_wth(Integer.parseInt(resp[180]));
		} else {
			pojo.setRm12_wth(Integer.parseInt("0"));
		}
		...
		if (resp[184] != null && resp[184].trim().length() != 0) {
			pojo.setRm2_len(Integer.parseInt(resp[184]));
		} else {
			pojo.setRm2_len(Integer.parseInt("0"));
		}
		pojo.setRm2_out(resp[185]);
		if (resp[186] != null && resp[186].trim().length() != 0) {
			pojo.setRm2_wth(Integer.parseInt(resp[186]));
		} else {
			pojo.setRm2_wth(Integer.parseInt("0"));
		}
		...
		if (resp[190] != null && resp[190].trim().length() != 0) {
			pojo.setRm3_len(Integer.parseInt(resp[190]));
		} else {
			pojo.setRm3_len(Integer.parseInt("0"));
		}
		pojo.setRm3_out(resp[191]);
		if (resp[192] != null && resp[192].trim().length() != 0) {
			pojo.setRm3_wth(Integer.parseInt(resp[192]));
		} else {
			pojo.setRm3_wth(Integer.parseInt("0"));
		}
		...
		if (resp[196] != null && resp[196].trim().length() != 0) {
			pojo.setRm4_len(Integer.parseInt(resp[196]));
		} else {
			pojo.setRm4_len(Integer.parseInt("0"));
		}
		pojo.setRm4_out(resp[197]);
		if (resp[198] != null && resp[198].trim().length() != 0) {
			pojo.setRm4_wth(Integer.parseInt(resp[198]));
		} else {
			pojo.setRm4_wth(Integer.parseInt("0"));
		}
		...
		if (resp[202] != null && resp[202].trim().length() != 0) {
			pojo.setRm5_len(Integer.parseInt(resp[202]));
		} else {
			pojo.setRm5_len(Integer.parseInt("0"));
		}
		pojo.setRm5_out(resp[203]);
		if (resp[204] != null && resp[204].trim().length() != 0) {
			pojo.setRm5_wth(Integer.parseInt(resp[204]));
		} else {
			pojo.setRm5_wth(Integer.parseInt("0"));
		}
		...
		if (resp[208] != null && resp[208].trim().length() != 0) {
			pojo.setRm6_len(Integer.parseInt(resp[208]));
		} else {
			pojo.setRm6_len(Integer.parseInt("0"));
		}
		pojo.setRm6_out(resp[209]);
		if (resp[210] != null && resp[210].trim().length() != 0) {
			pojo.setRm6_wth(Integer.parseInt(resp[210]));
		} else {
			pojo.setRm6_wth(Integer.parseInt("0"));
		}
		...
		if (resp[214] != null && resp[214].trim().length() != 0) {
			pojo.setRm7_len(Integer.parseInt(resp[214]));
		} else {
			pojo.setRm7_len(Integer.parseInt("0"));
		}
		pojo.setRm7_out(resp[215]);
		if (resp[216] != null && resp[216].trim().length() != 0) {
			pojo.setRm7_wth(Integer.parseInt(resp[216]));
		} else {
			pojo.setRm7_wth(Integer.parseInt("0"));
		}
		...
		if (resp[220] != null && resp[220].trim().length() != 0) {
			pojo.setRm8_len(Integer.parseInt(resp[220]));
		} else {
			pojo.setRm8_len(Integer.parseInt("0"));
		}
		pojo.setRm8_out(resp[221]);
		if (resp[222] != null && resp[222].trim().length() != 0) {
			pojo.setRm8_wth(Integer.parseInt(resp[222]));
		} else {
			pojo.setRm8_wth(Integer.parseInt("0"));
		}
		...
		if (resp[226] != null && resp[226].trim().length() != 0) {
			pojo.setRm9_len(Integer.parseInt(resp[226]));
		} else {
			pojo.setRm9_len(Integer.parseInt("0"));
		}
		pojo.setRm9_out(resp[227]);
		if (resp[228] != null && resp[228].trim().length() != 0) {
			pojo.setRm9_wth(Integer.parseInt(resp[228]));
		} else {
			pojo.setRm9_wth(Integer.parseInt("0"));
		}
		if (resp[229] != null && resp[229].trim().length() != 0) {
			pojo.setRms(Integer.parseInt(resp[229]));
		} else {
			pojo.setRms(Integer.parseInt("0"));
		}
		if (resp[230] != null && resp[230].trim().length() != 0) {
			pojo.setRooms_plus(Integer.parseInt(resp[230]));
		} else {
			pojo.setRooms_plus(Integer.parseInt("0"));
		}
		...
		if (resp[244] != null && resp[244].trim().length() != 0) {
			pojo.setSp_dol(Integer.parseInt(resp[244]));
		} else {
			pojo.setSp_dol(Integer.parseInt("0"));
		}
		...
		if (resp[258] != null && resp[258].trim().length() != 0) {
			pojo.setTaxes(Integer.parseInt(resp[258]));
		} else {
			pojo.setTaxes(Integer.parseInt("0"));
		}
		...
		if (resp[261] != null && resp[261].trim().length() != 0) {
			pojo.setTot_park_spcs(Integer.parseInt(resp[261]));
		} else {
			pojo.setTot_park_spcs(Integer.parseInt("0"));
		}
		pojo.setTour_url(resp[262]);
		if (resp[263] != null && resp[263].trim().length() != 0) {
			pojo.setTv(Integer.parseInt(resp[263]));
		} else {
			pojo.setTv(Integer.parseInt("0"));
		}
		...
		if (resp[283] != null && resp[283].trim().length() != 0) {
			pojo.setWater_front(Integer.parseInt(resp[283]));
		} else {
			pojo.setWater_front(Integer.parseInt("0"));
		}
		pojo.setWater_inc(resp[284]);
		pojo.setWater_type(resp[285]);
		pojo.setWaterfront(resp[286]);
		if (resp[287] != null && resp[287].trim().length() != 0) {
			pojo.setWcloset_p1(Integer.parseInt(resp[287]));
		} else {
			pojo.setWcloset_p1(Integer.parseInt("0"));
		}
		if (resp[288] != null && resp[288].trim().length() != 0) {
			pojo.setWcloset_p2(Integer.parseInt(resp[288]));
		} else {
			pojo.setWcloset_p2(Integer.parseInt("0"));
		}
		if (resp[289] != null && resp[289].trim().length() != 0) {
			pojo.setWcloset_p3(Integer.parseInt(resp[289]));
		} else {
			pojo.setWcloset_p3(Integer.parseInt("0"));
		}
		if (resp[290] != null && resp[290].trim().length() != 0) {
			pojo.setWcloset_p4(Integer.parseInt(resp[290]));
		} else {
			pojo.setWcloset_p4(Integer.parseInt("0"));
		}
		if (resp[291] != null && resp[291].trim().length() != 0) {
			pojo.setWcloset_p5(Integer.parseInt(resp[291]));
		} else {
			pojo.setWcloset_p5(Integer.parseInt("0"));
		}
		if (resp[292] != null && resp[292].trim().length() != 0) {
			pojo.setWcloset_t1(Integer.parseInt(resp[292]));
		} else {
			pojo.setWcloset_t1(Integer.parseInt("0"));
		}
		pojo.setWcloset_t1lvl(resp[293]);
		if (resp[294] != null && resp[294].trim().length() != 0) {
			pojo.setWcloset_t2(Integer.parseInt(resp[294]));
		} else {
			pojo.setWcloset_t2(Integer.parseInt("0"));
		}
		pojo.setWcloset_t2lvl(resp[295]);
		if (resp[296] != null && resp[296].trim().length() != 0) {
			pojo.setWcloset_t3(Integer.parseInt(resp[296]));
		} else {
			pojo.setWcloset_t3(Integer.parseInt("0"));
		}
		pojo.setWcloset_t3lvl(resp[297]);
		if (resp[298] != null && resp[298].trim().length() != 0) {
			pojo.setWcloset_t4(Integer.parseInt(resp[298]));
		} else {
			pojo.setWcloset_t4(Integer.parseInt("0"));
		}
		pojo.setWcloset_t4lvl(resp[299]);
		if (resp[300] != null && resp[300].trim().length() != 0) {
			pojo.setWcloset_t5(Integer.parseInt(resp[300]));
		} else {
			pojo.setWcloset_t5(Integer.parseInt("0"));
		}
		...
		if (resp[305] != null && resp[305].trim().length() != 0) {
			pojo.setYr(Integer.parseInt(resp[305]));
		} else {
			pojo.setYr(Integer.parseInt("0"));
		}
	...
	void createMLSListItem() {
		System.out.println("Data creation started...");
		mlsRepo.save(new MLSData("Central Air",
				"Great Opportunity To Rent A Fully Renovated Brand New Room(6-Month-Old) In Prime Old Cabbagetown 3 Story Detached Property. High Ceiling, Large Window, High-Speed Internet, Fitness Room, Gaming/Tv Room, Laundry Room, Modern Kitchen For Each Fl, New Bathroom, 2nd & 3rd Fl Deck, All-Inclusive Rent. Occupancy Immediate, Desirable Downtown Living, Minutes To Subway, Public Transportation, Coffee Shop, Restaurant, Supermarket, Hospital, All Amenities, And More.",
				"Cabbagetown-South St. James Town", "C5443495"));
		mlsRepo.save(new MLSData("Wall Unit",
				"Beautiful 2 Bedroom 1 Bathroom Unit With Parking In Sought After Lawrence Park. Over 800 Square Feet, Lovely Open Concept Kitchen Living Room, With Newer Appliances. Located Close To Transit/Highways, Shopping, Restaurants, & Amazing Schools!",
				"Lawrence Park North", "C5464416"));
		System.out.println("Data creation complete...");
	}
	...
	public String getListingDetails(MLSData item) {

		System.out.println("Ac Name: " + item.getA_c() + ", \nAd Text: " + item.getAd_text() + ", \nCommnity: "
				+ item.getCommunity());
